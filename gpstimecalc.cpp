#include "GPSTimeCalculator.h"
#include <ctime>

void GetGPSTime(FGPSTime &CurrentGPSTime)
{
    int leapseconds = 18;
    ...
    CurrentGPSTime.tow = 86400.0 * day_number + seconds;
    CurrentGPSTime.day = day_number;
    ...
    CurrentGPSTime.rollover = rollover;
    CurrentGPSTime.weeknum = weeknum;
}
